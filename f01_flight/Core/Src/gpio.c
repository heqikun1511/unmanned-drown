...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : SPI1_NSS_Pin SPI_EN_Pin LED2_Pin LED1_Pin */
  GPIO_InitStruct.Pin = SPI1_NSS_Pin|SPI_EN_Pin|LED2_Pin|LED1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : POWERKEY_Pin LED4_Pin LED3_Pin */
  GPIO_InitStruct.Pin = POWERKEY_Pin|LED4_Pin|LED3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure SI24R1 CE pin */
