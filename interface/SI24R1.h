...
#define CE_LOW HAL_GPIO_WritePin(SPI1_CE_GPIO_Port, SPI1_CE_Pin, GPIO_PIN_RESET)   // CE = 0
#define CE_HIGH HAL_GPIO_WritePin(SPI1_CE_GPIO_Port, SPI1_CE_Pin, GPIO_PIN_SET)    // CE = 1
//********************************************************************************************************************//
// SPI(SI24R1) commands
